...
Official TypeScript SDK for the [PayRaider](https://github.com/Ndifreke000/stellar-insights) API — payment corridor reliability, liquidity, trustline, and network-health data for the Stellar network.
...
`createClient` covers the common case of pointing at PayRaider's own
