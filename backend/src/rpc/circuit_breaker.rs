...
use failsafe::{Config, backoff::Exponential, failure_policy::ConsecutiveFailures};
pub type SharedCircuitBreaker = Arc<failsafe::breaker::CircuitBreaker<Exponential, ConsecutiveFailures>>;
